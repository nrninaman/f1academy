...
    display: none;
    position: absolute;
    /* Styles for positioning and layout */
    top: 38px; /* FIX: Reduced 'top' from 45px to 38px to minimize gap */
    left: 50%;
    transform: translateX(-50%);
    padding: 20px;
    padding-top: 25px; /* FIX: Added extra padding to top to extend the hover catch area */
    min-width: 800px;
    z-index: 200;
